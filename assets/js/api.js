...
$.ajax({
    url: "https://api.pexels.com/v1/search?query=vegetables&orientation=landscape&size=large",
    ...
    $(`<style type='text/css'> .heroPic{ background: url(${data.photos[randomNum].src.large}) no-repeat center; background-size: 100%; } </style>`).appendTo("head");
